...
final List<Email> emails = [
  ...
  Email(
    ...
    subject: 'Dinner Club',
    content:
        'I think is it time for us to finally try that new noodle shop downtown that doesnt use menus. Anyone else have other suggestions for dinner club this week? I am so intrigued by this idea of a noodle restaurant where no one gets to order for themselves - could be fun, or terrible, or both :)\n\nSo',
  ),
  Email(
    sender: user_3,
    recipients: [],
    ...
    content:
        'Ping– you love this new food show I started watching. Is it produced by a Thai drummer who started getting recognized for the amazing vegan food she always brought to shows.',
...
final List<Email> replies = [
  ...
  Email(
    ...
    subject: 'Dinner Club',
    content:
        'Yes! I forgot about that place! I am definitely up for taking a risk this week and handing control over to this mysterious noodle chef. I wonder what happens if you have allergies though? Lucky none of us have any otherwise Id be a bit concerned.\n\nThis is going to be great. See you all at the usual time?',
  ),
];